...
- Mapa de calor por ponto e hora; 1.100 acidentes com coordenada (dado aberto do Estado).
...
## Como contribuir
Issue no repositório público. Regras: número com origem, sem dado pessoal, sem dado policial.
