## Nomes que dizem "extrair inteligência do que a cidade já tem" (proposta, 19/09 11:40)

A inovação declarada: **não instalar nada novo; ligar e ler o que já existe** (Conecta Patos, Olho Vivo, semáforo em teste, relatório da operadora, bases públicas). O nome tem que carregar isso. Régua: cabe na primeira frase do pitch · um morador entende · não promete vigilância.
...
## Mensagem para o grupo geral do hackathon (para o Enio enviar; texto na voz dele)
...
Não tem estratégia de time nem dado de empresa. É só o que é público. Se acharem erro ou tiverem fonte melhor, abram uma issue lá ou me chamem aqui.
