...
## Acrescentado às 20h55 — o que os áudios do grupo pediram (transcritos hoje)

12. **Cada um explica a sua parte ao grupo, como se estivesse apresentando.** Pedido num áudio: se a pessoa explica bem, o grupo enxerga o que falta; se erra ou esquece algo, o grupo corrige na hora. É o ensaio e a revisão ao mesmo tempo. — sem dono
13. **Revisar amanhã o que ficou de fora**, cada um corrigindo a parte que criou. — sem dono
14. **Mostrar a alguém da prefeitura com poder de decisão** ainda durante o evento. — sem dono
15. **Perguntar quais dados a prefeitura olha primeiro** e por quais critérios avalia (pedido num áudio: "quais são os dados mais críticos a ponto de tomar decisão"). — sem dono
16. **Confirmar o número real de câmeras ativas** (a imprensa diz 240 em 140 pontos; na mesa falaram 300 e 700). — sem dono

## Preço — decidido em 19/09 20h40
Entrada pelo **diagnóstico** (1 hora de vídeo + relatório): é um sim fácil, não exige autorização de sistema nem licitação. Atrás dele, **piloto de 90 dias por R$ 49.375**, que cabe na dispensa de licitação (teto de R$ 65.492,11 em 2026). Preço vai à banca como **sugestão fundamentada**, não proposta comercial. Não oferecer desenvolvimento por valor simbólico em licitação: proposta inexequível é desclassificada.
